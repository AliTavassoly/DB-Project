...
FOREIGN KEY(COURSE_ID) REFERENCES COURSE(COURSE_ID));
CREATE TABLE QueraEcoPlus.CRS_PARTICIPANTS(USER_ID varchar(10), COURSE_ID varchar(10), 
...
CREATE TABLE QueraEcoPlus. ACTIVITY_HISTORY_PROBLEMS(USER_ID varchar(10), PROBLEM_ID varchar(10), score INT,
