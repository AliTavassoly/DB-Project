DROP DATABASE IF EXISTS QueraEcoPlus;
CREATE DATABASE QueraEcoPlus;

CREATE TABLE QueraEcoPlus.SKILLS(SKILL_NAME varchar(10), SKILL_TYPE varchar(10),
...
CREATE TABLE QueraEcoPlus.COMPANY(COMPANY_REGISTRATION_ID varchar(10), ADDR varchar(10),
                    ...
                    PHONE_1 varchar(10) ,PHONE_2 varchar(10),PHONE_3 varchar(10),
                    PRIMARY KEY (COMPANY_REGISTRATION_ID));

CREATE TABLE QueraEcoPlus.ADVERTISEMENT(COMPANY_REGISTRATION_ID varchar(10) , ADD_ID varchar(10),
INFO_FILE_LOCATION varchar(100), EXPERIENCE_YR INT, IS_PART_TIME BOOLEAN,
...
SKILL_NAME varchar(10), SKILL_LEVEL INT,
PRIMARY KEY(COMPANY_REGISTRATION_ID, ADD_ID, SKILL_NAME),
...
FIRST_NAME varchar(10), LAST_NAME varchar(10), NATIONAL_ID varchar(10),
PRIMARY KEY (USER_ID));
...
CREATE TABLE QueraEcoPlus.CV_PROJ_LINKS(user_id INT, URL varchar(100), 
...
CREATE TABLE QueraEcoPlus.REQUESTS(USER_ID INT, COMPANY_REGISTRATION_ID varchar(10), ADD_ID varchar(10), STAT varchar(20),
...
CREATE TABLE QueraEcoPlus.COURSE_MATERIAL(COURSE_ID varchar(10), MATERIAL_ID varchar(10), FILE_LOCATION varchar(100), UPLOAD_DATE DATETIME,
...
HW_DESCRIPTION_FILE_LOCATION varchar(100), FILE_SIZE_LIMIT INT,
...
DELIVARY_DATE DATETIME , FILE_LOCATION varchar(100), 
...
DESCRIPTION_FILE_LOCATION varchar(100), DIFFICULTY_LEVEL INT, 
PRIMARY KEY(PROBLEM_ID));

CREATE TABLE QueraEcoPlus.PROBLEM_SKILL(PROBLEM_ID varchar(10), SKILL_NAME varchar(10), DIFFICULTY_LEVEL INT, 
PRIMARY KEY(PROBLEM_ID, SKILL_NAME), 
FOREIGN KEY(PROBLEM_ID) REFERENCES PROBLEM(PROBLEM_ID),
FOREIGN KEY(SKILL_NAME) REFERENCES SKILLS(SKILL_NAME));

CREATE TABLE QueraEcoPlus.SUBMISSION(SUBMISSION_ID INT NOT NULL AUTO_INCREMENT, PROBLEM_ID varchar(10), USER_ID INT, SUBMISSION_FILE_LOCATION varchar(100),
SCORE INT,
CHECK (SCORE >= 0),
CHECK (SCORE <= 100),
...
DESCRIPTION_FILE_LOCATION varchar(100), BEGINNING_DATE DATETIME, ENDING_DATE DATETIME, IS_PUBLIC BOOLEAN,
...
CREATE TABLE QueraEcoPlus.CONTEST_PARTICIPANTS(USER_ID INT, CONTEST_ID varchar(10), SCORE INT, RNK INT,
CHECK (SCORE >= 0),
CHECK (SCORE <= 100),
...
CREATE TABLE QueraEcoPlus.NOTIFICATION(NOTIFICATION_ID INT NOT NULL AUTO_INCREMENT, CREATION_DATE DATETIME, BODY TEXT(500),
PRIMARY KEY(NOTIFICATION_ID));

CREATE TABLE QueraEcoPlus.USER_NOTIFICATION(NOTIFICATION_ID INT, USER_ID INT,
PRIMARY KEY(NOTIFICATION_ID),
...
CREATE TABLE QueraEcoPlus.NEW_ADD_NOTIF(NOTIFICATION_ID INT, COMPANY_REGISTRATION_ID varchar(10), ADD_ID varchar(10),
PRIMARY KEY(NOTIFICATION_ID),
...
CREATE TABLE QueraEcoPlus.REQUEST_STATUS_UPDATE(NOTIFICATION_ID INT, user_id INT,
...
CREATE TABLE QueraEcoPlus.NEW_REQUEST_NOTIF(NOTIFICATION_ID INT, user_id INT, 
COMPANY_REGISTRATION_ID varchar(10), ADD_ID varchar(10),
PRIMARY KEY(NOTIFICATION_ID),
FOREIGN KEY(NOTIFICATION_ID) REFERENCES NOTIFICATION(NOTIFICATION_ID)
                                    ON DELETE CASCADE
