...
CREATE TABLE QueraEcoPlus.USER(USER_ID varchar(10),EMAIL_ADD varchar(15),
FIRST_NAME varchar(10),LAST_NAME varchar(10),NATIONAL_ID varchar(10), PRIMARY KEY (USER_ID));

CREATE TABLE QueraEcoPlus.CV(USER_ID varchar(10), BIRTH_DATE DATETIME, GENDER varchar(3), IS_MARRIED BOOLEAN,
...
CREATE TABLE QueraEcoPlus.CV_PHONES(USER_ID varchar(10), PHONE_NUMBER varchar(15), 
PRIMARY KEY(USER_ID, PHONE_NUMBER), FOREIGN KEY(USER_ID) REFERENCES USER(USER_ID));

CREATE TABLE QueraEcoPlus.CV_PROJ_LINKS(USER_ID varchar(10), URL varchar(20), 
PRIMARY KEY(USER_ID, URL), FOREIGN KEY(USER_ID) REFERENCES USER(USER_ID));

CREATE TABLE QueraEcoPlus.CV_SKILLS(USER_ID varchar(10), SKILL_NAME varchar(10), SKILL_LEVEL INT,
PRIMARY KEY(USER_ID, SKILL_NAME), FOREIGN KEY(USER_ID) REFERENCES USER(USER_ID), 
FOREIGN KEY(SKILL_NAME) REFERENCES SKILLS(SKILL_NAME));


CREATE TABLE QueraEcoPlus.CV_EDU_HISTORY(USER_ID varchar(10), CRS_NAME varchar(15), ORG_NAME varchar(10),
CERTIFATE_URL varchar(20), SCORE INT, PRIMARY KEY(USER_ID, CRS_NAME),
FOREIGN KEY(USER_ID) REFERENCES USER(USER_ID));

CREATE TABLE QueraEcoPlus.CV_WORK_INFO(USER_ID varchar(10), DESIRED_INCOME INT,
IS_PART_TIME BOOLEAN , WORK_HOURS INT, DESIRED_JOB_TITLE varchar(10),
WORK_EXP_YR INT, EMPLOYMENT_STATUS varchar(10), 
PRIMARY KEY(USER_ID), FOREIGN KEY(USER_ID) REFERENCES USER(USER_ID));

CREATE TABLE QueraEcoPlus.CV_WORK_INFO_INTRESTS(USER_ID varchar(10), SKILL_NAME varchar(10),
PRIMARY KEY(USER_ID,SKILL_NAME), FOREIGN KEY(USER_ID) REFERENCES USER(USER_ID),
FOREIGN KEY(SKILL_NAME) REFERENCES SKILLS(SKILL_NAME));

CREATE TABLE QueraEcoPlus.REQUESTS(USER_ID varchar(10), COMPANY_REGISTRATION_ID varchar(10), ADD_ID varchar(10),STATUS varchar(20),
...
CREATE TABLE QueraEcoPlus.COURSE_MATERIAL_PROVIDER(COURSE_ID varchar(10), USER_ID varchar(10),
...
CREATE TABLE QueraEcoPlus.COURSE_MATERIAL(COURSE_ID varchar(10), FILE_LOCATION varchar(20),UPLOAD_DATE DATETIME,
PRIMARY KEY(COURSE_ID,FILE_LOCATION), FOREIGN KEY(COURSE_ID) REFERENCES COURSE(COURSE_ID));
...
CREATE TABLE QueraEcoPlus.HW_DELIVERY(COURSE_ID varchar(10), HW_TITLE varchar(15), USER_ID varchar(10),
...
CREATE TABLE QueraEcoPlus. USER_ACTIVITY_HISTORY(USER_ID varchar(10),
PRIMARY KEY(USER_ID),
FOREIGN KEY(USER_ID) REFERENCES USER(USER_ID));

CREATE TABLE QueraEcoPlus. ACTIVITY_HISTORY_PROBLEMS(USER_ID varchar(10), PROBLEM_ID varchar(10),
PRIMARY KEY(USER_ID, PROBLEM_ID),
FOREIGN KEY(USER_ID) REFERENCES USER(USER_ID),
FOREIGN KEY(PROBLEM_ID) REFERENCES PROBLEM(PROBLEM_ID));

CREATE TABLE QueraEcoPlus.ACTIVITY_HISTORY_CONTEST(USER_ID varchar(10), CONTEST_ID varchar(10), SCORE INT,
...
CREATE TABLE QueraEcoPlus.USER_NOTIFICATION(NOTIFICATION_ID varchar(10), USER_ID varchar(10),
PRIMARY KEY(NOTIFICATION_ID),
...
CREATE TABLE QueraEcoPlus.REQUEST_STATUS_UPDATE(NOTIFICATION_ID varchar(10),USER_ID varchar(10),
...
CREATE TABLE QueraEcoPlus.NEW_REQUEST_NOTIF(NOTIFICATION_ID varchar(10), USER_ID varchar(10), 
COMPANY_REGISTRATION_ID varchar(10), ADD_ID varchar(10),
PRIMARY KEY(NOTIFICATION_ID),
FOREIGN KEY(NOTIFICATION_ID) REFERENCES NOTIFICATION(NOTIFICATION_ID),
FOREIGN KEY(USER_ID,COMPANY_REGISTRATION_ID, ADD_ID) REFERENCES REQUESTS(USER_ID, COMPANY_REGISTRATION_ID, ADD_ID));