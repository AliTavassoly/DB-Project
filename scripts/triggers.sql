...
FOR EACH ROW BEGIN
    ...
    WHILE i < n DO
        ...
        SELECT MAX(USER.USER_ID) FROM USER INTO not_id;
        
        INSERT INTO NOTIFICATION(CREATION_DATE, BODY) VALUES(CURRENT_TIME, 'new job offer');
        INSERT INTO USER_NOTIFICATION VALUES(not_id + 1, user_id);
        INSERT INTO NEW_ADD_NOTIF VALUES(not_id + 1, NEW.COMPANY_REGISTRATION_ID, NEW.ADD_ID);
        SET i = i + 1;
    END WHILE;
END;
